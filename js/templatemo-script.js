        ...
        form.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (hasAction) {
                    ...
                    .then(async (response) => {
                        if (!response.ok) {
                            ...
                            try {
                                ...
                                throw new Error(data.error || 'Er is iets misgegaan. Probeer het later opnieuw.');
                            } catch (e) {
                    ...
                    .catch(() => {
                        submitButton.innerHTML = '<i class="fas fa-exclamation-triangle"></i> Probeer opnieuw';
                    })
                    .finally(() => {
                        setTimeout(() => {
                    ...
                    // Fallback: simulate success for forms without an action (e.g., newsletter)
                    setTimeout(() => {
                        formElement.reset();
                        submitButton.innerHTML = '<i class="fas fa-check"></i> Verzonden';
